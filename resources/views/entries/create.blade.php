                        ...
                        <div class="flex flex-col my-auto gap-y-10 md:gap-y-18 font-normal text-md md:text-lg">
                            <div class="md:w-full flex flex-col md:flex-row gap-8">
                                <div class="md:w-1/2 flex flex-col gap-y-10">
                                    ...
                                    <div class="relative flex flex-col">
                                        <label for="entry_time" class="font-semibold">Chegada Estimada: </label>
                                        <input type="datetime-local" name="entry_time" id="entry_time" class="px-2 md:px-4 py-1 md:py-2 border-2 border-slate-400 rounded-sm">
                                        <span class="absolute top-full">
                                            @error('entry_time')
                                                {{$message}}
                                            @enderror
