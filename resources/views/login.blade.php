    ...
    <div class="flex flex-col lg:flex-row w-screen h-screen">
        <div id="left-side" class="relative w-full lg:w-1/2 h-1/2 lg:h-screen bg-violet-400 shadow-lg lg:shadow-2xl shadow-slate-300">
            ...
            <div class="w-4/6 h-5/6 mx-auto my-6 grid grid-rows-4 lg:grid-rows-3 content-center">
                ...
                <form class="h-fit my-auto lg:my-0 grid grid-rows-2 row-span-2 lg:row-span-1 gap-3 lg:gap-10 font-semibold" action="" name="loginForm">
                    <div class="w-full flex flex-col mx-auto">
                        <label class="text-white text-xl lg:text-3xl" for="usernameInput">Username: </label>
                        <input class="px-2 lg:px-2 py-1 lg:py-3 text-lg lg:text-2xl focus:outline-violet-500" type="text" name="usernameInput">
                    </div>
                    <div class="w-full flex flex-col mx-auto">
                        <label class="text-white text-xl lg:text-3xl" for="usernameInput">Password: </label>
                        <input class="px-2 lg:px-2 py-1 lg:py-3 text-lg lg:text-2xl focus:outline-violet-500" type="password" name="passwordInput">
                    </div>
                </form>
                <button class="w-full py-2 lg:py-4 mx-auto my-auto bg-violet-500 text-white text-xl lg:text-3xl font-semibold" form="loginForm" type="submit">LOGAR</button>
            </div>
        </div>
